...
class Plane_waves_methods:
    ...
    def low_depth_taylor_on_the_fly(self, N, lambd, Omega, eps_PEA, eps_HS, eps_S, Ham_norm, J):
        '''To be used in plane wave basis
        J: Number of atoms
        '''
        ...
        x = sympy.Symbol('x')
        order = self.tools.order_find(function = math.cos(x), x0 = 1, e = e, xeval = x_max)
